				...
				<div class="box">
					<div>
						<div class="body">
							...
							<ul id="sites">
								<li>
									<a href="<?= URL_ROOT ?>/dives.php"><img src="<?= URL_ROOT ?>/images/reef1.jpg" alt="Img"></a>
									<h2><a href="<?= URL_ROOT ?>/dives.php">Gale Reef</a></h2>
									<p>
								...
								<li>
									<a href="<?= URL_ROOT ?>/dives.php"><img src="<?= URL_ROOT ?>/images/reef2.jpg" alt="Img"></a>
									<h2><a href="<?= URL_ROOT ?>/dives.php">Dawson’s Reef</a></h2>
									<p>
								...
								<li>
									<a href="<?= URL_ROOT ?>/dives.php"><img src="<?= URL_ROOT ?>/images/reef3.jpg" alt="Img"></a>
									<h2><a href="<?= URL_ROOT ?>/dives.php">Claire’s REEF</a></h2>
									<p>
